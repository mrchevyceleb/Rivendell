...
- `ELROND_WORKSPACE_PATH` — pinned to `~/Library/CloudStorage/OneDrive-Personal/Documents/ASSISTANT-HUB`. Library reads this as a file tree; `node_modules` and `.git` load on demand.
