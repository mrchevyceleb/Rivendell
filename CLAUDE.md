...
- `ELROND_WORKSPACE_PATH` — pinned to `~/Library/CloudStorage/OneDrive-Personal/Documents/ASSISTANT-HUB`. Library room reads this as a file tree; heavy folders (`node_modules`, `.git`) load on demand.
